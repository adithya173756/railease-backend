...
export type StorageHash =
  StorageHashBase<'7e1cfcd8bf5b11e0e5ff28f6374df5d33092d60bde90d2e72e7fe0c1936eb32a'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Booking: {
      ...
      readonly journeyDate: CodecTypes['pg/text@1']['output'];
      readonly passengerName: CodecTypes['pg/text@1']['output'];
      readonly passengerAge: CodecTypes['pg/int4@1']['output'];
      readonly passengerGender: CodecTypes['pg/text@1']['output'];
      readonly classCode: CodecTypes['pg/text@1']['output'];
    ...
    readonly TrainAvailability: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly journeyDate: CodecTypes['pg/text@1']['output'];
      readonly availableSeats: CodecTypes['pg/int4@1']['output'];
      readonly status: CodecTypes['pg/text@1']['output'];
      readonly trainClassId: CodecTypes['pg/int4@1']['output'];
    };
    readonly TrainClass: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly code: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Booking: {
      ...
      readonly journeyDate: CodecTypes['pg/text@1']['input'];
      readonly passengerName: CodecTypes['pg/text@1']['input'];
      readonly passengerAge: CodecTypes['pg/int4@1']['input'];
      readonly passengerGender: CodecTypes['pg/text@1']['input'];
      readonly classCode: CodecTypes['pg/text@1']['input'];
    ...
    readonly TrainAvailability: {
      ...
      readonly status: CodecTypes['pg/text@1']['input'];
      readonly trainClassId: CodecTypes['pg/int4@1']['input'];
    };
    readonly TrainClass: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly code: CodecTypes['pg/text@1']['input'];
          ...
          readonly table: {
            readonly booking: {
              columns: {
                ...
                readonly journeyDate: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: false;
                };
                readonly passengerName: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: false;
                };
                readonly passengerAge: {
                  readonly nativeType: 'int4';
                  readonly codecId: 'pg/int4@1';
                  readonly nullable: false;
                };
                readonly passengerGender: {
                  readonly nativeType: 'text';
                  readonly codecId: 'pg/text@1';
                  readonly nullable: false;
                };
              ...
              uniques: readonly [{ readonly columns: readonly ['bookingNumber'] }];
              indexes: readonly [
                {
                  readonly name: 'booking_trainId_idx_6fd34429';
                  readonly prefix: 'booking_trainId_idx';
            ...
            readonly trainAvailability: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['trainClassId', 'journeyDate'] }];
              indexes: readonly [
                {
                  readonly name: 'trainAvailability_trainClassId_idx_5f06cb10';
                  readonly prefix: 'trainAvailability_trainClassId_idx';
                  readonly columns: readonly ['trainClassId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'trainAvailability';
                    readonly columns: readonly ['trainClassId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
...
> & {
  ...
  readonly roots: {
    ...
    readonly trainAvailability: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'TrainAvailability';
    };
          ...
          readonly Booking: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly journeyDate: { readonly column: 'journeyDate' };
                readonly passengerName: { readonly column: 'passengerName' };
                readonly passengerAge: { readonly column: 'passengerAge' };
                readonly passengerGender: { readonly column: 'passengerGender' };
                readonly classCode: { readonly column: 'classCode' };
          ...
          readonly TrainAvailability: {
            ...
            readonly relations: {
              readonly trainClass: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['trainClassId'];
                  readonly targetFields: readonly ['id'];
                };
              };
            };
            readonly storage: {
              readonly table: 'trainAvailability';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly journeyDate: { readonly column: 'journeyDate' };
                ...
                readonly status: { readonly column: 'status' };
                readonly trainClassId: { readonly column: 'trainClassId' };
              };
            };
          };
          readonly TrainClass: {
            ...
            readonly relations: {
              readonly availability: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['trainClassId'];
                };
              };
              readonly train: {
                readonly to: {
